...
const strangerPranks = ["Sensor no more: Harmless, but hilarious. If you want to see hilarious confusion unfold then just simply tape/draw over any electronic sensor (such as on a TV remote, under a computer mouse, over an automatic door cover). They won't know why everything is malfunctioning.....but you will.","Deceitful door: It happens on accident all the time, but now you can make it happen on purpose. Find a door that you can push or pull open. If the door already has a label indicating that you should either push or pull then just slap an official sticker over it saying the opposite. Best enjoyed in a place that gets busy. ","Salty work: Doesn't get any more simple than adding salt to someone's beverage. Patience is key, as soon as they leave their beverage vulnerable then add a packet of salt. You can continue to add packets of salt until they notice and don't forget to count how many packets it takes.","Lubed germ killer Find a container of hand sanitizer and then replace the contents with personal lubricant or clear school glue. When the unsuspecting victim starts to quickly rub their hands together to 'sanitize' their hands, they will either find that they can keep rubbing and rubbing and rubbing or that they cannot rub their hands together because they're sticking to each other!","Carmelized Onions? Instead of carmelized apples for Halloween, make carmelized onions! Take an onion, peel back some of the papery skin, jam a popsicle stick on an end and dip it into hot carmel! Watch your friends take a bite of the gooey treat until they take a bite of the onion!","Cling thing: All that's needed for this prank is plastic wrap. Wrap the plastic wrap across a doorway as high as your victim's height and then scream for them or announce something that you think would cause them to rush into the room. Sit back and enjoy their surprise when they run into an invisible force. ","Doh-gum: Buy a pack of gum and some play-doh (preferably white or the color of the gum). Remove the gum from the packets and repackage with the same size of play-doh (knead play-doh with a little wasabi for extra fun). Offer gum as needed. "," Pop down: If you'd like your victim to have a surprising visit to the restroom then buy some snap its. Tape a few snap its under the toilet seat and slowly set it back down. Now when your victim sits down to use the restroom, they will have a surprising time.","Classic scare: When you know your victim well you'll be able to pull off the most classic and terrifying prank yet. If you know their fears then simply play them out. If you're unsure of your victim's fear you can always put on a scary mask and wait in a dark room or around a corner (you can also be creative and hide in a fridge). Be ready to scare when your victim comes along. ","Spicy Awakening: First pick a hot sauce and find a sleeping victim, preferably with their mouth open. Simply shake a few drops of hot sauce in their mouth and watch them wake up with a kick. "]
